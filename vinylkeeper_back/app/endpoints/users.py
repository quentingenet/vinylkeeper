...
def login(
    ...
    try:
        ...
        # Le gestionnaire d'exception s'occupe déjà du logging
        raise
...
def register(
    ...
    try:
        ...
        try:
            user_service.send_new_user_registered_email(user, background_tasks)
        ...
        # Laisser l'exception AppException remonter pour avoir les détails dans le gestionnaire
        raise
